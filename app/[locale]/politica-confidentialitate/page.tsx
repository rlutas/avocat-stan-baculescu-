...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title =
    locale === 'ro'
      ? 'Politica de Confidentialitate | Stan-Baculescu'
      : 'Privacy Policy | Stan-Baculescu Law Firm';
  const description =
    locale === 'ro'
      ? 'Politica de confidentialitate a Stan-Baculescu. Aflati cum colectam, utilizam si protejam datele dumneavoastra personale.'
