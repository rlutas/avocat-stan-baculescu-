      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-navy px-8 py-16 text-center sm:px-16">
          ...
          <div className="relative">
            <h2 className="animate-fade-in-up font-heading mb-4 text-3xl font-bold tracking-tight text-white sm:text-4xl">
              {t('title')}
            </h2>
            <p className="animate-fade-in-up delay-100 mx-auto mb-8 max-w-2xl text-lg text-white/70">
              {t('description')}
            </p>
            <Button
              asChild
              size="lg"
              className="animate-fade-in-up delay-200 animate-pulse-glow group h-14 rounded-full bg-gold px-8 text-base font-semibold text-navy transition-all duration-300 hover:bg-gold-light hover:shadow-lg hover:shadow-gold/30"
            >
              <Link href="/contact">
                {t('button')}
