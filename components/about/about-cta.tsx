  ...
  return (
    <section className="py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-amber-500 to-amber-600 px-8 py-16 text-center sm:px-16">
          {/* Background Pattern */}
          ...
          <div className="relative">
            ...
            <Button
              asChild
              size="lg"
              className="h-14 bg-white px-8 text-base font-semibold text-amber-600 hover:bg-white/90"
            >
              <Link href="/contact">
                {t('button')}
