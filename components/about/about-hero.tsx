      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
        <div className="text-center">
          ...
          <h1 className="animate-fade-in-up delay-100 mb-6 font-heading font-bold leading-tight text-white">
            <span className="block text-xl sm:text-2xl lg:text-3xl text-white/70 font-medium">{t('titleLine1')}</span>
            <span className="block text-4xl sm:text-5xl md:text-6xl">{t('titleLine2')}</span>
          </h1>

          {/* Description */}
          <p className="animate-fade-in-up delay-200 mx-auto max-w-2xl text-lg leading-relaxed text-white/70 sm:text-xl">
            {t('subtitle')}
          </p>
        </div>
      </div>
